...
int main()
{
     ...
     */
    cars.emplace_back("camper");
    cars.emplace_back("conversion van");
    /*
    ...
    motorcycles.emplace_back("crotchRocket2");

    trucks.emplace_back("walmart");
    trucks.emplace_back("safeway");
    trucks.emplace_back("jons");
    trucks.emplace_back("vons");
